      ...
      *
       ...
       01 WS-UCTRANS                  PIC S9(8) COMP
                                                 VALUE 0.
       01 STORED-UCTRANS              PIC S9(8) COMP
                                                 VALUE 0.
      ...
      *
           IF INQCUST-FIRST-NAME = SPACES AND
              ...
              MOVE SPACES TO CUSTAD1O CUSTAD2O CUSTCITYO
              MOVE SPACES TO CUSTPOSTO CUSTCTRYO
      ...
      *
           ...
           MOVE INQCUST-ADDR-LINE1 TO CUSTAD1O.
           MOVE INQCUST-ADDR-LINE2 TO CUSTAD2O.
           MOVE INQCUST-CITY TO CUSTCITYO.
           MOVE INQCUST-POSTCODE TO CUSTPOSTO.
           MOVE INQCUST-COUNTRY TO CUSTCTRYO.
           ...
           ELSE
              STRING
                 'Customer lookup successful. <PF5> to Delete. <PF10'
                 DELIMITED BY SIZE,
                 '> to Update.                       '
                 DELIMITED BY SIZE
                 INTO MESSAGEO
      ...
      *
           ...
           MOVE SORTCI TO COMM-SCODE OF DELCUS-COMMAREA
      ...
      *
           ...
           MOVE SPACES TO CUSTCITYO.
           MOVE SPACES TO CUSTPOSTO.
           MOVE SPACES TO CUSTCTRYO.
      ...
      *
           ...
           MOVE CUSTCITYI TO COMM-CITY OF UPDCUST-COMMAREA.
           MOVE CUSTPOSTI TO COMM-POSTCODE OF UPDCUST-COMMAREA.
           MOVE CUSTCTRYI TO COMM-COUNTRY OF UPDCUST-COMMAREA.

           MOVE DOBDDI TO COMM-DOBX-DD.
           MOVE DOBMMI TO COMM-DOBX-MM.
           MOVE DOBYYI TO COMM-DOBX-YYYY.
           MOVE COMM-DOB9-DD TO COMM-DOB-DAY OF COMM-DOB
              OF UPDCUST-COMMAREA.
           MOVE COMM-DOB9-MM TO COMM-DOB-MONTH OF COMM-DOB
              OF UPDCUST-COMMAREA.
           MOVE COMM-DOB9-YYYY TO COMM-DOB-YEAR OF COMM-DOB
              OF UPDCUST-COMMAREA.
      ...
      *
           ...
           MOVE COMM-CITY OF UPDCUST-COMMAREA TO CUSTCITYO.
           MOVE COMM-POSTCODE OF UPDCUST-COMMAREA TO CUSTPOSTO.
           MOVE COMM-COUNTRY OF UPDCUST-COMMAREA TO CUSTCTRYO.

           MOVE COMM-DOB-DAY OF COMM-DOB OF UPDCUST-COMMAREA
              TO COMM-DOB-SPLIT-DD.
           MOVE COMM-DOB-MONTH OF COMM-DOB OF UPDCUST-COMMAREA
              TO COMM-DOB-SPLIT-MM.
           MOVE COMM-DOB-YEAR OF COMM-DOB OF UPDCUST-COMMAREA
              TO COMM-DOB-SPLIT-YYYY.
           MOVE COMM-DOB-SPLIT-DD TO DOBDDO.
           MOVE COMM-DOB-SPLIT-MM TO DOBMMO.
           MOVE COMM-DOB-SPLIT-YYYY TO DOBYYO.
      ...
      *
           ...
           MOVE CUSTCITYO TO COMM-CITY OF DFHCOMMAREA.
           MOVE CUSTPOSTO TO COMM-POSTCODE OF DFHCOMMAREA.
           MOVE CUSTCTRYO TO COMM-COUNTRY OF DFHCOMMAREA.
      ...
      *
           ...
           MOVE DFHGREEN TO CUSTCITYC.
           MOVE 'A' TO CUSTCITYA.
           MOVE DFHUNDLN TO CUSTCITYH.

           MOVE DFHGREEN TO CUSTPOSTC.
           MOVE 'A' TO CUSTPOSTA.
           MOVE DFHUNDLN TO CUSTPOSTH.

           MOVE DFHGREEN TO CUSTCTRYC.
           MOVE 'A' TO CUSTCTRYA.
           MOVE DFHUNDLN TO CUSTCTRYH.
      ...
      *
           ...
           MOVE DFHNEUTR TO CUSTCITYC.
           MOVE DFHBMPRF TO CUSTCITYA.
           MOVE HIGH-VALUES TO CUSTCITYH.

           MOVE DFHNEUTR TO CUSTPOSTC.
           MOVE DFHBMPRF TO CUSTPOSTA.
           MOVE HIGH-VALUES TO CUSTPOSTH.

           MOVE DFHNEUTR TO CUSTCTRYC.
           MOVE DFHBMPRF TO CUSTCTRYA.
           MOVE HIGH-VALUES TO CUSTCTRYH.
